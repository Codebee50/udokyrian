...
const ContactSection = () => {
  return (
    <section className="w-[90%] min-h-screen max-w-[1100px]  flex flex-col-reverse sm:flex-row justify-between items-stretch gap-7 sm:gap-[70px] md:gap-[70px] pt-10 scroll-mt-[50px]" id="contact">
        <div className="flex flex-col rounded-xl w-full sm:w-[50%]">
            ...
            <form action="" className="mt-10 flex flex-col gap-7">
                ...
                <input type="submit" value="Submit" className="w-full md:w-[90%] max-w-[400px] mt-5 border rounded-lg border-complement-color text-complement-color font-poppins py-3 px-20 hover:bg-complement-color hover:text-deep-background transition-all ease-in-out duration-300" />
            </form>
        </div>
        ...
        <div className="flex flex-col w-full sm:w-[50%] h-full">
            ...
            <div className="flex flex-col rounded-xl w-full h-full">
                <ContactFlatCard icon={RiMailLine} label="Email" value="onuhudoudo@gmail.com" href="mailto:onuhudoudo@gmail.com"/>
                <ContactFlatCard icon={RiPhoneLine} label="Phone" value="+234 9128 168 542" href="tel:+2349128168542" />
            </div>
        </div>
    </section>
  )
